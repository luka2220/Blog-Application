...
// Creating post schema (Database)
const postSchema = new mongoose.Schema({
  title: String,
  post: String
});

// Creating database model for blogpostDB collection
...
app.get("/", function(req, res){
  ...
  BlogPost.find(function (err, foundBlogs) {
    if (err) {
      console.log(err);
    } else {
      res.render("home", {
...
app.post("/compose", function(req, res){
  ...
  // Creating new document for submitted blog post (Database)
...
app.get("/posts/:postName", function(req, res){
  ...
  // Search through DB for post with specified id
